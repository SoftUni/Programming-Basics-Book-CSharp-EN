...
**We are testing** what is up to now by starting with [**Ctrl + F5**]:
   ...
   * **Shooting from top** &rarr; the top firing must remove the top fruit in the hit column or cause the game to end if there is dynamite. In fact, at the end of the game nothing is going to happen, because in the view this case is still not considered.
   * **Shooting from bottom** &rarr; the shooting from bottom should remove the lowest fruit in the hit column or end the game when you hit the dynamite.
